            ...
            <div className="py-16">
                <Container maxWidth="md">
                        ...
                        <Paper style={{backgroundColor: "white"}} elevation={isFocused ? 4 : 1}>
                            <Box p={2}>
                                <input onChange={event => setNewTitle(event.target.value)} value={newTitle}
                                       ...
                                       placeholder="New search name" className="w-full text-lg focus:outline-none"/>
                            </Box>
                        </Paper>
                    </Box>
                    {creationMode ? <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            ...
                            })} value={sourceObject.twitter} sourceName="Twitter" icon="fab fa-twitter mr-2" disclaimer=""/>
                            <SourceInputPanel setValue={newValue => setSourceObject({
                    ...
                    <div className="w-full flex justify-end mt-6">
                        <Button disabled={newTitle.length < 1 || isLoading} disableElevation variant="contained" size="medium" color="primary"
